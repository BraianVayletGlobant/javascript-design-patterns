...
function appSingleton() {
    ...
    console.log(`singleton1 and singleton2 are equal? ${singleton1 === singleton2 ? "yes" : "no"}`);
    console.log(`singleton2 and singleton3 are equal? ${singleton2 === singleton3 ? "yes" : "no"}`);
